 ...
 * @version 2.1
 */
public class Base64ForAppEngine {
	 ...
	 *            Specified options
	 * @return The Base64-encoded object
	 * @see Base64ForAppEngine#GZIP
	 * @see Base64ForAppEngine#DONT_BREAK_LINES
	 * @since 2.0
	 */
	public static String encodeObject(java.io.Serializable serializableObject,
			int options) {
		...
		try {
			...
			b64os = new Base64ForAppEngine.OutputStream(baos, ENCODE | dontBreakLines);
	...
	public static String encodeBytes(byte[] source, int off, int len,
		...
		if (gzip == GZIP) {
			java.io.ByteArrayOutputStream baos = null;
			java.util.zip.GZIPOutputStream gzos = null;
			Base64ForAppEngine.OutputStream b64os = null;
	...
	public static byte[] decodeFromFile(String filename) {
		...
		Base64ForAppEngine.InputStream bis = null;
		try {
			...
			// Open a stream
			bis = new Base64ForAppEngine.InputStream(new java.io.BufferedInputStream(
					new java.io.FileInputStream(file)), Base64ForAppEngine.DECODE);
	...
	public static String encodeFromFile(String filename) {
		...
		try {
			...
			// Open a stream
			bis = new Base64ForAppEngine.InputStream(new java.io.BufferedInputStream(
					new java.io.FileInputStream(file)), Base64ForAppEngine.ENCODE);
			...
			encodedData = new String(buffer, 0, length,
					Base64ForAppEngine.PREFERRED_ENCODING);
	...
	/**
	 * A {@link Base64ForAppEngine.InputStream} will read data from another
	 * <tt>java.io.InputStream</tt>, given in the constructor, and encode/decode
	 * to/from Base64 notation on the fly.
	 * 
	 * @see Base64ForAppEngine
	 * @since 1.3
	 */
	public static class InputStream extends java.io.FilterInputStream {
		...
		/**
		 * Constructs a {@link Base64ForAppEngine.InputStream} in DECODE mode.
		 * 
		 * @param in
		...
		/**
		 * Constructs a {@link Base64ForAppEngine.InputStream} in either ENCODE or DECODE
		 * mode.
		 * <p>
		 * Valid options:
		 * 
		 ...
		 * @param options
		 *            Specified options
		 * @see Base64ForAppEngine#ENCODE
		 * @see Base64ForAppEngine#DECODE
		 * @see Base64ForAppEngine#DONT_BREAK_LINES
		 * @since 2.0
		 */
	...
	/**
	 * A {@link Base64ForAppEngine.OutputStream} will write data to another
	...
	public static class OutputStream extends java.io.FilterOutputStream {
		...
		/**
		 * Constructs a {@link Base64ForAppEngine.OutputStream} in ENCODE mode.
		 * 
		 * @param out
		...
		/**
		 * Constructs a {@link Base64ForAppEngine.OutputStream} in either ENCODE or DECODE
		 * mode.
		 * <p>
		 * Valid options:
		 * 
		...
		public void write(int theByte) throws java.io.IOException {
			...
			// Else, Decoding
				...
				if (DECODABET[theByte & 0x7f] > WHITE_SPACE_ENC) {
					...
					{
						int len = Base64ForAppEngine.decode4to3(buffer, 0, b4, 0);
						out.write(b4, 0, len);
