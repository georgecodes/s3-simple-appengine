...
public class Constants {
	...
	/**
	 * The name of the <a
	 * href="http://jets3t.s3.amazonaws.com/toolkit/configuration.html#jets3t"
	 * >JetS3t properties</a> file: jets3t.properties
	 */
	...
	/**
	 * The name of the <a
	 * href="http://jets3t.s3.amazonaws.com/toolkit/configuration.html#ignore"
	 * >JetS3t ignore</a> file: .jets3t-ignore
	 */
	 ...
	 */
	public static File DEFAULT_PREFERENCES_DIRECTORY = new File(
			System.getProperty("user.home") + "/.jets3t");

	/**
	 * The file delimiter used by JetS3t is the '/' character, which is
	 * compatible with standard browser access to S3 files.
	 */
	...
	/**
	 * Metadata header for storing the original date of a local file uploaded to
	 * S3, so it can be used subsequently to compare files instead of relying on
	 * the S3 upload date.
	 */
	public static final String METADATA_JETS3T_LOCAL_FILE_DATE = "jets3t-original-file-date-iso8601";

	/**
	 * Metadata header for storing information about the data encryption
	 * algorithm applied by JetS3t tools.
	 */
	public static final String METADATA_JETS3T_CRYPTO_ALGORITHM = "jets3t-crypto-alg";

	/**
	 * Metadata header for storing information about the JetS3t version of
	 * encryption applied (to keep encryption compatibility between versions).
	 */
	public static final String METADATA_JETS3T_CRYPTO_VERSION = "jets3t-crypto-ver";

	/**
	 * Metadata header for storing information about data compression applied by
	 * jets3t tools.
	 */
	...
	/**
	 * A flag used to indicate that the sender is willing to accept any
	 * Requester Pays bucket fees imposed by the request. This flag may be used
	 * in request Headers, or as a parameter.
	 */
